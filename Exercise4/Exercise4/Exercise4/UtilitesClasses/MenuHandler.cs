namespace Exercise4.UtilitesClasses
{
    ...
    {
        static int choice = 0;
        static public Garage? garage { get; set; }
        ...
        static public Menu MenuAddVehicle = new Menu("Lägg till fordon", new MenuItem[]
         {
        ...
        static public readonly Menu MenuShowVehicle = new Menu("Visa fordon", new MenuItem[]
        {
